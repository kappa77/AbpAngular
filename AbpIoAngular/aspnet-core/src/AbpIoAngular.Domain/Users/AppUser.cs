...
namespace AbpIoAngular.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpIoAngularDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpIoAngularEfCoreEntityExtensionMappings to extend the IdentityUser entity
